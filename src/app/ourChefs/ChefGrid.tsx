...
const chefs = [
  ...
  { name: "Tahmina Rumi", role: "Cook", image: "/chef1.png" },
  { name: "Bisnu Devgon", role: "Chef", image: "/chef1.png" },
  { name: "Motin Molladst", role: "Chef", image: "/chef1.png" },
  { name: "William Rumi", role: "Chef", image: "/chef1.png" },
  { name: "Kets William Roy", role: "Chef", image: "/chef1.png" },
  { name: "Mahmud Kholil", role: "Chef", image: "/chef1.png" },
  { name: "Ataur Rahman", role: "Chef", image: "/chef1.png" },
  { name: "Monalisa Holly", role: "Chef", image: "/chef1.png" },
];
